                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    ...
                                    <?php if ($role === 'admin'): ?>
                                        <form method="post"
                                              action="<?php echo htmlspecialchars(app_url('pages/animals_delete.php'), ENT_QUOTES, 'UTF-8'); ?>"
                                              class="d-inline js-confirm-form"
                                              data-confirm-title="<?php echo htmlspecialchars('Delete animal record?', ENT_QUOTES, 'UTF-8'); ?>"
                                              data-confirm-message="<?php echo htmlspecialchars('This will permanently remove this animal profile and its linked records.', ENT_QUOTES, 'UTF-8'); ?>"
                                              data-confirm-button="<?php echo htmlspecialchars('Delete Animal', ENT_QUOTES, 'UTF-8'); ?>">
